...
M.sections = {
  ...
  { name = "Zellij", lines = {
    ...
    "Alt+1-9          jump to tab N    Alt+i / Alt+o  reorder tab",
    "Alt+h/j/k/l      move between panes / adjacent tabs",
    "Alt+f            toggle floating terminal   (Ctrl+p i: pin)",
    "Ctrl+p then...   n new pane, x close, d / r split down/right",
    "Ctrl+s / Ctrl+n  scrollback (e: edit in nvim) / resize mode",
    "Ctrl+o then d    detach (keeps running)     Ctrl+q  quit",
    "Ctrl+o then w    session manager: switch / rename / kill (UI)",
    "",
    "-- sessions (in a shell on the box running zellij) --",
    "$ zjls           see running + resurrectable sessions",
